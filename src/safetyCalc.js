...
function calcDisplacementTime (initialSpeed, sectorLength, accelRate, maxSpeed){
	...
	*/
	...
	if (initialSpeed.value < maxSpeed.value){
		...
		let maxSpeedDistRemaining = {value: ( accelDistanceRemaining.value < sectorLength.value ) ? (sectorLength.value - accelDistanceRemaining.value) : 0, unit: sectorLength.unit};
